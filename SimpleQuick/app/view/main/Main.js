 ...
 */
Ext.define('SimpleQuick.view.main.Main', {
                ...
                '->',
                {
                    ...
                    listeners:{
                        toggle(button,pressed,e){
                            if(pressed){
                                let createView = Ext.create('SimpleQuick.view.main.windowMessage.listMessage', {
                                    width:500,
                                    height:500,
                                    buttonmain:button,
                                    itemId:'taskdata',
                ...
                },
                {
                    ...
                    listeners:{
                        toggle(button, pressed, e) {
                            ...
                            if(pressed){
                                let createView = Ext.create('SimpleQuick.view.main.task.list', {
                                    width:500,
                                    height:500,
                                    list_urgent:[],
                                    itemId:'taskdata',
